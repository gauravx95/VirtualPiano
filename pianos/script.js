...
window.addEventListener("keydown", ({ keyCode }) => {
  ...
  // Press 3
  if (keyCode === 51) return playGb4();

  // Press S
  if (keyCode === 83) return playG4();

  // Press 4
  if (keyCode === 52) return playAb4();

  // Press D
  if (keyCode === 68) return playA4();

  // Press 5
  if (keyCode === 53) return playBb4();

  // Press F
  if (keyCode === 70) return playB4();

  // Press Z
  if (keyCode === 90) return playC5();

  // Press 6
  if (keyCode === 54) return playDb5();

  // Press X
  if (keyCode === 88) return playD5();

  // Press 7 
  if (keyCode === 55) return playEb5();

  // Press C
  if (keyCode === 67) return playE5();
});
